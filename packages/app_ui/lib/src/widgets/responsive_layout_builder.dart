  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= LastArcherStandingBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= LastArcherStandingBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= LastArcherStandingBreakpoints.large) {
